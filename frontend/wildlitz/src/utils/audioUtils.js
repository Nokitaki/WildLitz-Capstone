// Create a new file: src/utils/audioUtils.js

/**
 * Utility functions for handling audio in the WildLitz application
 */
...
export const playAudio = async ({
  ...
  /**
   * Fix the format of base64 audio data to ensure it's playable
   * 
