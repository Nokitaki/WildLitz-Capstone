# backend/wildlitz/syllabification/services.py - CLEANED VERSION
...
class ChatGPTService:
    ...
    def generate_syllabification_words(self, difficulty_level, count=10, categories=None):
        ...
        try:
            ...
            return [
                {"word": "apple", "syllables": "ap-ple", "count": 2, "category": "Food Items" if "Food Items" in categories else default_category},
                {"word": "banana", "syllables": "ba-na-na", "count": 3, "category": "Food Items" if "Food Items" in categories else default_category},
